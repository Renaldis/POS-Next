...
export default function Dashboard() {
  ...
  const { data: revenue } = useQuery({
    ...
    queryFn: async () => {
      ...
      const totalOrderThisMonth = (dataThisMonth ?? []).length;
    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <Card>
          ...
          <CardFooter>
            <div className="text-muted-foreground">*Average per day</div>
          </CardFooter>
        </Card>
        <Card>
          <CardHeader>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <Card className="w-full lg:w-1/3">
          <CardHeader>
            ...
            <CardDescription>
              Showing last 5 active orders {lastWeek.toLocaleDateString()} to{" "}
              {new Date().toLocaleDateString()}
            </CardDescription>
          </CardHeader>
          <div className="px-6">
